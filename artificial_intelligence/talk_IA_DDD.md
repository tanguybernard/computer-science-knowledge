...
C'est **moins risqué que la Santé** (pas de morts), mais **plus fun que la Formation** (pop-corn !). C'est un excellent choix pour un talk grand public ou tech, car tout le monde visualise très bien les problèmes.

Tu pars là-dessus ? Si oui, je peux te donner le prompt exact pour initialiser le "Projet A" (le mauvais) afin qu'il tombe pile dans les pièges.
